...
The server exposes ~37 tools across **library** (read), **playlists**,
...
**From your phone (the Claude app):** the server can run over Streamable HTTP
behind a Cloudflare Tunnel, so you can reach it remotely. See
