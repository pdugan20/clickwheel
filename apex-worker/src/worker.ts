...
const DOCS_ORIGIN = 'https://docs.clickwheel.fm';

// Self-contained landing page for the apex. It advertises ONLY the transparent
// favicon and NO apple-touch. clickwheel.fm previously redirected straight to
// the Mintlify docs, whose page advertises a transparent apple-touch icon that
// Google's favicon service flattens onto black (a JPEG at 48/64px that the
...
<h1>clickwheel</h1>
<p>Sync your music library to a classic iPod from a modern Mac, with optional Claude/MCP control.</p>
